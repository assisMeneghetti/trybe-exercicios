...
} = require('./src/controllers/patientsController');
const { getAllPlans } = require('./src/controllers/plansController');
const { getDoctorSurgeries } = require('./src/controllers/surgeriesController');
